...
# INFORMATION: NN FEATURES
fig2 = plt.figure(num=2, figsize=(0.8, 3), dpi=80, facecolor='w', edgecolor='k')
fig2.text(.3, .9,  'RNN = %s' %(str(RNN)[21:-2]), color = 'k',
        horizontalalignment='center')
fig2.text(.3, .8,  'VSIZE = %d' %(VSIZE), color = 'k',
        horizontalalignment='center')
fig2.text(.3, .7,  'HIDDEN_SIZE = %d' %(HIDDEN_SIZE), color = 'k',
        horizontalalignment='center')
fig2.text(.3, .6,  'BATCH_SIZE = %d' %(BATCH_SIZE), color = 'k',
        horizontalalignment='center')
fig2.text(.3, .5,  'LAYERS = %d' %(LAYERS), color = 'k',
        horizontalalignment='center')
fig2.text(.3, .4,  'INVERT = %s' %(str(INVERT)), color = 'k',
        horizontalalignment='center')
fig2.text(.3, .3,  'ITERATIONS = %d' %(iteration), color = 'k',
        horizontalalignment='center')
plt.show()
